use		CRIME;
Select * from dbo.crime_by_district;
--creating DIM_STATE
...
delete from DIM_STATE where state_id = 25;

delete from DIM_STATE where state_id = 14;
...
select * from Total_crimes_by_district;
